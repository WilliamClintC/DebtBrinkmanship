...
It has also been noted we have debt crisis without default has become more common, wherein there was a near missed payment but never a default has a negative effect on output, as exemplified in Greece Portugal and Spain during 2010-2012 [@mitchener2023] . Going a step further some have propose to change the definition of debt crises to yield spreads of 1000 basis points, also known as spread spikes [@broner2013; @aguiar; @krishnamurthy].
...
There has also been work on how credit rating agencies downgrading reduces leverage and investments [@almeida2017]. Similar conclusions were drawn using CDS risk premium instead of bond yield spreads [@brutti2015; @bahaj2020].
...
Previous literature etablishes the recent development of increasing high public debt\[ @mitchener2023 \].
...
![](style-guide/Debt plot.png){width="462"}
...
We will use IMF definition and ifs dataset to accomplish this.
We investigate if the output decline show by [@yeyati2011] is present. We also propose a similar graph using imports on the y axis in line with [@mendoza2012]. We investigate debt to market cap levels fo firms [@corsetti2012; @das2010; @gourinchas2016]s.
We investigate investments [@almeida2017]

We consider China for the follwing reasons.
